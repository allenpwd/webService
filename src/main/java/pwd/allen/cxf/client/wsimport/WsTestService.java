 ...
 * 
 */
@WebServiceClient(name = "WsTestService", targetNamespace = "http://allen.pwd/", wsdlLocation = "http://127.0.0.1:8090/service/WsTest?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSTESTSERVICE_QNAME = new QName("http://allen.pwd/", "WsTestService");
    ...
    public WsTest getWsTestPort() {
        return super.getPort(new QName("http://allen.pwd/", "WsTestPort"), WsTest.class);
    }
    ...
    public WsTest getWsTestPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://allen.pwd/", "WsTestPort"), WsTest.class, features);
    }
